...
export default function ForgotPassword({ toggleForm }: { toggleForm: (action: string) => void }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_APP_API_BASE_URL}/auth/forgot-password`, {
        method: "POST",
        headers: {
